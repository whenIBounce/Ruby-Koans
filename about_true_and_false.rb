...
class AboutTrueAndFalse < Neo::Koan
  # :true_stuff and :false_stuff are being used as return values
  #  in the truth_value method. 
  # They are a way of communicating the result of the method 
  # more clearly than simply returning true or false would.
